...
const Banner = ({ image, title, subtitle, link, tag, reverse }) => {
    return (
        <div className="bg-[#f9f9f9] pb-14 flex justify-center">
            <div className="container">
                <div className="grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0">
                    ...
                    <div className="flex flex-col justify-center text-center md:text-left space-y-4 lg:max-w-[500px]">
                        ...
                        >
                            <button className="bg-blue-500 py-2 px-3 rounded-lg text-white shadow-lg hover:scale-105 active:scale-95 active:bg-blue-600 focus:95 !mt-5">Get Started</button>
                        </motion.div>
                    </div>
                </div>
            </div>
